...
for epnum in range (1,4):
    ...
    numepochs = epnum
    Test_Version = "Client" + str(numepochs) + "HotSimple_3ConvIncr"
    ...
    for j in range(2,11):
        ...
        #Print line info
        plinfo = "Cifar10, Num Class: " + str(numclasses)

        #Image Files
        path = './CIFAR10SC_' + str(numclasses) + '.pickle'
        filename = 'CIFAR10SC_' + str(numclasses) + '.pickle'
        #nn files
        startnnfilename = './CIFAR10_' + str(numclasses-1) + '.pt'
